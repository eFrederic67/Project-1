...
<section>
    ...
    <article class="descriptions">
        <h5 class="titre">Descriptions</h5>
        ...
        <p>Nous intervenons principalement dans le rayon de <strong>Strasbourg</strong> Eurométropole :</p>
